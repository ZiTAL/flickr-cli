...
class ApiFactory
{
     ...
     * @return \SimpleXMLElement
     */
    public function upload($file, $title = null, $description = null, $tags = null, $isPublic = null, $isFriend = null, $isFamily = null, $safetyLevel = null, $contentType = null, $hidden = null)
    {
        $path = realpath($file);
